...
namespace primal::script
{
	namespace
	{
		...
		{
			// we put this static variable in a function because 
			// of the initializaiton of static data. This way, we can be 
			// certain that the data is initiazlieed before accessing it.
